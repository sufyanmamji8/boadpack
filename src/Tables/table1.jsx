...
const Table1 = () => {
  return (
    <div className="min-h-screen bg-white p-4 md:p-6 lg:p-8" style={{ fontFamily: 'Arial, sans-serif' }}>
      {/* Header */}
 <div className="text-center mb-1 md:mb-2 py-0.5 relative flex items-center justify-center">
...
<div className="lg:flex-1">
  {/* Top Left Information Block with Image */}
  <div className="flex items-start bg-white p-2 md:p-3 mb-2 md:mb-3 w-full lg:w-auto">
    {/* Image Container */}
    <div className="hidden md:block flex-shrink-0 mr-0 mt-[-1px] mt-1">
      <img 
        src={top2}
