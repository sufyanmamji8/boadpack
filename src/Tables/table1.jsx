        ...
        <div className="lg:flex-1">
          ...
          <div className="bg-white p-4 md:p-5 mb-4 md:mb-6 border border-gray-300 rounded-lg w-full lg:w-auto">
            <div className="mb-2 md:mb-3 text-xs md:text-sm">
              <span className="mr-2">•</span> <strong>Jeddah Airport Car Park Bays</strong> 12,442
            </div>
            <div className="mb-2 md:mb-3 text-xs md:text-sm">
              <span className="mr-2">•</span><strong>Contract term</strong> 4 years & 07 months; start date 06/01/2021 to 31/07/2025
            </div>
            <div className="mb-2 md:mb-3 text-xs md:text-sm">
              <span className="mr-2">•</span><strong>Operational Hours</strong> 24 Hours per day
            </div>
            <div className="mb-2 md:mb-3 text-xs md:text-sm">
              <span className="mr-2">•</span><strong>Parking charges are excluding of VAT 15%</strong>
            </div>
